...
export class Auth {
    ...
    async redirect() {
        ...
        try {
            let baseURL = 'https://cssa.cunyfirst.cuny.edu';
            let response = await this.client.get(`${baseURL}${this.redirectURL}`, { headers });

            //may need to switch to name instead of user
